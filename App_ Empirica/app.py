"""
================================================================================
Empirica App: Plataforma Base + 3 Pasos + QA/QC + Paso 2 Control Manual
================================================================================
"""
...
# ---------------------------------------------------------------------------------
# PASO 2: DOM2 GEOLÓGICO (AHORA CON SLIDERS MANUALES Y TODOS LOS GRÁFICOS)
# ---------------------------------------------------------------------------------
...
st.sidebar.markdown("<div style='text-align: center; color: #666;'>Empirica v14.0 (Paso 2 Validaciones)</div>", unsafe_allow_html=True)
